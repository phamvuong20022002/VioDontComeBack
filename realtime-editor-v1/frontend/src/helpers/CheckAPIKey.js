export const checkOpenAPIKey = async (apiKey) => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return {
        status: false,
        message: errorMessage.error.code === "insufficient_quota" ? "Your API key has expired or has not been paid. Please pay and reactivate!":"API key is invalid" ,
        details: errorMessage.error.message,
        errors_details: 'https://platform.openai.com/docs/guides/error-codes/api-errors'
      };
    }
  } catch (error) {
